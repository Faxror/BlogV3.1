...
namespace DataAccessLayerr.Migrations
{
    ...
    [Migration("20251018101040_CommentsUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayerr.Concrate.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayerr.Concrate.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayerr.Concrate.Comment", b =>
                {
                    b.HasOne("EntityLayerr.Concrate.AppUser", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("EntityLayerr.Concrate.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("EntityLayerr.Concrate.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
